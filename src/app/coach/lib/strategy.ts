...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      "Showing up for fiancé, friends, and family while running 50 properties",
      "The pharmacy school sunk cost trap — $150K loans, 8 years, walking away anyway",
      "Only telling my parents and brother about my first Airbnb",
      "First cabin, first month — things broke but the money was so good I didn't care",
      "Pueblo to Salida — 3-hour drives to cover travel pharmacist shifts",
